...
function registrarUsuario() {
    ...
    rl.question('Ingresa tu nombre de usuario: ', function (nombreUsuario) {
        rl.question('Ingresa tu correo electrónico: ', function (correo) {
            rl.question('Ingresa tu contraseña (máximo 6 dígitos): ', function (contrasena) {
                ...
                if (usuarios[nombreUsuario] || Object.values(usuarios).find(function (usuario) { return usuario.correo === correo; })) {
