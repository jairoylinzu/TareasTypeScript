...
var mensaje = readline.createInterface(({
    input: process.stdin,
    output: process.stdout
}));
var diccionario = {};
mensaje.question('Por favor ingresa tu nombre: ', function (nombre) {
    if (nombre != 'nombre') {
        diccionario['nombre'] = nombre.toLocaleUpperCase();
        console.log(diccionario);
    }
    mensaje.question('Por favor ingresa tu correo: ', function (correo) {
        if (correo != 'correo') {
        ...
        mensaje.question('Por favor ingresa tu contrasena: ', function (cerrar) {
